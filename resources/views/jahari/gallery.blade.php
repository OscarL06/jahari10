...
@section('content')
    ...
    <section class="relative flex flex-col w-full">
        ...
        <div class="flex flex-col items-center">
            <h1 class="mt-10 mb-8 tracking-wider text-white text-8xl font-abel">PHOTOS</h1>
        </div>
    </section>

    <section class="flex justify-center w-full mt-20">
        <div class="w-3/4 gap-8 columns-2">
            <img class="w-full mb-8" src="/images/L1380678.jpg" />
            <img class="w-full mb-8" src="/images/L1380537.jpg" />
            <img class="w-full mb-8" src="/images/_TOL0076.jpg" />
            <img class="w-full mb-8 aspect-square" src="/images/L1380675.jpg" />
            <img class="w-full mb-8" src="/images/L1380452.jpg" />
            <img class="w-full mb-8" src="images/L1380634.jpg" />
            <img class="w-full mb-8 aspect-square" src="/images/_TOL0085.jpg" />
        </div>
    </section>
